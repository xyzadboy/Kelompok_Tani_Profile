...
<footer class="border-t border-emerald-900/10 bg-stone-900 text-stone-300">
    <div class="mx-auto max-w-7xl px-4 pt-16 pb-12 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-5 lg:gap-8">
            ...
            <div class="space-y-4 lg:col-span-2">
                <a href="/" class="flex items-center gap-3">
                    <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-500 to-green-700 text-white shadow-md">
                        <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 21V11m0 0C12 7.5 9 5 5 5c0 4 2.5 7 7 6zm0 0c0-3.5 3-6 7-6 0 4-2.5 7-7 6z" />
                        </svg>
                    </div>
                ...
                <p class="text-sm leading-relaxed text-stone-400 max-w-sm">
                    Wadah kolaborasi dan pemberdayaan petani lokal untuk mewujudkan ketahanan pangan, inovasi pertanian berkelanjutan, dan kesejahteraan bersama.
                </p>
            ...
            <div>
                ...
                <ul class="mt-4 space-y-2.5 text-sm">
                    ...
                    <li>
                        <a href="/legalitas" class="transition-colors hover:text-emerald-400">Legalitas Kelompok</a>
                    </li>
                    <li>
                        <a href="/gallery" class="transition-colors hover:text-emerald-400">Galeri Kegiatan</a>
                    </li>
                    <li>
                        <a href="/blog" class="transition-colors hover:text-emerald-400">Artikel & Blog</a>
                    </li>
                    <li>
                        <a href="/contact" class="transition-colors hover:text-emerald-400">Kontak Pengurus</a>
                    </li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="mt-4 space-y-3 text-sm text-stone-400">
                    <li class="flex items-start gap-2.5">
                        <svg class="h-5 w-5 text-emerald-500 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" />
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" />
                        </svg>
                        <span>Jl. Tani Makmur No. 12, Desa Beruas, Indonesia</span>
                    </li>
                    ...
                    <li class="flex items-center gap-2.5">
                        ...
                        <span>kontak@beruasharapan.id</span>
                    </li>
                </ul>
            </div>
        ...
        <div class="mt-12 border-t border-stone-800 pt-8 flex flex-col items-center justify-between gap-4 text-xs text-stone-500 sm:flex-row">
            <p>© {{ date('Y') }} Kelompok Tani Beruas Harapan. Hak Cipta Dilindungi.</p>
